...
5 continue
  if(command_argument_count().eq.1.and.plot.eq.0) then
...
35   write(6,'(A37)', advance='no')' Choose the X-axis variable (0-201): '
     read*,vx
  ...
  if(plot.lt.2) then      
36   write(6,'(A53)', advance='no')' Choose the Y-axis variable (0-62, 81-115, 202-209): '
     read*,vy
